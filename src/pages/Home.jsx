...
const HomePage = () => {
  return (
    <div className="home-page">
      ...
      <section className="introduction py-12 px-6 bg-red-50 text-center rounded-lg shadow-md">
        ...
        <p className="text-xl mt-4 max-w-3xl mx-auto leading-relaxed text-gray-800">
  ...
  <div className="pt-5 flex flex-wrap justify-center gap-8 overflow-x-auto pb-5">
    <div className="event-card w-[45%] bg-green-100 p-6 rounded-lg shadow-lg transition-transform transform hover:scale-105 hover:text-black hover:shadow-xl">
      <div className="flex gap-4">
        <FaFlask className="text-4xl mb-4 text-green-800" />
        <h3 className="text-2xl font-bold mb-2 text-green-800">Science Fair</h3>
      </div>
    ...
    <div className="event-card w-[45%] bg-yellow-100 p-6 rounded-lg shadow-lg transition-transform transform hover:scale-105 hover:text-black hover:shadow-xl">
      <div className="flex gap-4">
        <FaMusic className="text-4xl mb-4 text-yellow-800" />
        <h3 className="text-2xl font-bold mb-2 text-yellow-800">Cultural Festival</h3>
      </div>
    ...
    <div className="event-card w-[45%] bg-blue-100 p-6 rounded-lg shadow-lg transition-transform transform hover:scale-105 hover:text-black hover:shadow-xl">
      <div className="flex gap-4">
        <FaChalkboardTeacher className="text-4xl mb-4 text-blue-800" />
        <h3 className="text-2xl font-bold mb-2 text-blue-800">Parent-Teacher Meeting</h3>
      </div>
    ...
    <div className="event-card w-[45%] bg-pink-100 p-6 rounded-lg shadow-lg transition-transform transform hover:scale-105 hover:text-black hover:shadow-xl">
      <div className="flex gap-4">
        <FaFlask className="text-4xl mb-4 text-pink-800" />
        <h3 className="text-2xl font-bold mb-2 text-pink-800">Art Exhibition</h3>
      </div>
    ...
    <div className="event-card w-[45%] bg-purple-100 p-6 rounded-lg shadow-lg transition-transform transform hover:scale-105 hover:text-black hover:shadow-xl">
      <div className="flex gap-4">
        <FaBook className="text-4xl mb-4 text-purple-800" />
        <h3 className="text-2xl font-bold mb-2 text-purple-800">Book Fair</h3>
      </div>
  ...
  <h2 className="text-4xl font-extrabold text-blue-600">Our Achievements</h2>
  <div className="flex flex-wrap justify-center mt-8 gap-8">
    <div className="achievement-card bg-green-100 p-6 rounded-lg shadow-md max-w-xs transition-transform transform hover:scale-105 hover:shadow-lg">
      <h3 className="text-2xl font-bold text-green-800">Top School in Region</h3>
      <p className="mt-2 text-gray-700">
        Springdale Public School has been ranked the top school in the region for academic excellence.
      </p>
    </div>
    <div className="achievement-card bg-yellow-100 p-6 rounded-lg shadow-md max-w-xs transition-transform transform hover:scale-105 hover:shadow-lg">
      <h3 className="text-2xl font-bold text-yellow-800">100% Graduation Rate</h3>
      <p className="mt-2 text-gray-700">
        We are proud to have a 100% graduation rate, with our students excelling in various fields.
      </p>
    </div>
    <div className="achievement-card bg-blue-100 p-6 rounded-lg shadow-md max-w-xs transition-transform transform hover:scale-105 hover:shadow-lg">
      <h3 className="text-2xl font-bold text-blue-800">Sports Championships</h3>
      <p className="mt-2 text-gray-700">
        Our school has won numerous sports championships, showcasing our students' athletic talents.
      </p>
    </div>
    <div className="achievement-card bg-pink-100 p-6 rounded-lg shadow-md max-w-xs transition-transform transform hover:scale-105 hover:shadow-lg">
      <h3 className="text-2xl font-bold text-pink-800">Community Service Excellence</h3>
      <p className="mt-2 text-gray-700">
        Our students have been recognized for outstanding contributions to community service and volunteering.
      </p>
    </div>
    <div className="achievement-card bg-purple-100 p-6 rounded-lg shadow-md max-w-xs transition-transform transform hover:scale-105 hover:shadow-lg">
      <h3 className="text-2xl font-bold text-purple-800">Innovative Science Projects</h3>
      <p className="mt-2 text-gray-700">
        We have been awarded for our innovative science projects and research in various fields.
      </p>
    </div>
  </div>
</section>
